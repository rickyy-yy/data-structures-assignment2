...
namespace Task1 {
    ...
    struct Order {
        ...
        void inProcess()                    { status = "Processing"; }
        void completed()                    { status = "Completed";  }
        void assignRobot(int assignedRobotID){ robotID = assignedRobotID; }
    };
    ...
    struct UnlimitedQueue {
        ...
        UnlimitedQueue() : front(nullptr), rear(nullptr), count(0) {}
